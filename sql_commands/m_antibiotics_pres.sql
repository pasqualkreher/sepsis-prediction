-- Modified from: https://github.com/BorgwardtLab/mgp-tcn/tree/master/src/query

DROP TABLE IF EXISTS m_antibiotics_pres; 
CREATE TABLE m_antibiotics_pres AS 
...
SELECT
    pres.icustay_id,
    pres.antibiotic_name,
    pres.antibiotic_starttime,
    pres.antibiotic_endtime,
    pres.antibiotic
FROM pres
INNER JOIN m_subjects ON pres.icustay_id = m_subjects.icustay_id
WHERE antibiotic = 1
;